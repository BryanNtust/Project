              ...
              <div class="u-container-style u-layout-cell u-right-cell u-size-60 u-size-xs-60 u-white u-layout-cell-1" src="">
                <div class="u-container-layout u-container-layout-1">
                    <form action="signup-check.php" method="post">
                         <h2 class="u-align-center u-text u-text-default u-text-1">SIGN UP</h2>
                         ...
                         <label class="u-align-center u-text u-text-default u-text-1">Name</label>
                         ...
                         <input type="password" 
                              ...
                              class="u-align-center u-text u-text-default u-text-1"><br>

                         <label class="u-align-center u-text u-text-default u-text-1">Re Password</label>
                         <input type="password" 
                              name="re_password" 
                              placeholder="Re_Password"
                              class="u-align-center u-text u-text-default u-text-1"><br>

                         <button class="u-align-center u-text u-text-default u-text-1" type="submit">Sign Up</button>
                         <a href="index.php" class="u-align-center u-text u-text-default u-text-1" class="ca">Already have an account?</a>
                    </form>
                </div>
              </div>
            </div>
